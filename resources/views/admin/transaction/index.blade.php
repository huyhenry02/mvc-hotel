                    ...
                    <div class="card-body">
                        <table class="table table-bordered">
                            ...
                            <tr class="text-center">
                                ...
                                <th class="d-none d-xl-table-cell">Số tiền</th>
                            ...
                            @foreach($transactions as $key => $transaction)
                                <tr class="text-center">
                                    ...
                                    <td class="d-none d-xl-table-cell">{{$transaction->booking->code ?? ''}}</td>
                                    ...
                                    <td class="d-none d-xl-table-cell">{{ number_format($transaction->amount, 0, ',', '.') }}</td>
